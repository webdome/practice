(function () {
  ...
  "Android" == F2xSystem.osType ? F2xInit(30, "flash2xDiv", window.innerWidth, window.innerHeight, main) : F2xInit(30, "flash2xDiv", window.innerWidth, window.innerHeight, main)
